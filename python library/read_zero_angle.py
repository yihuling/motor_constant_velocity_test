...
class TestModule:
	...
	def Enable_three_motor(self,):
		...
		self.Read_Reply_Data(1)
		self.mmc.send_command(2, 0, 0, 0, 0,  0)
		self.Read_Reply_Data(2)
		self.mmc.send_command(3, 0, 0, 0, 0,  0)
		self.Read_Reply_Data(3)
		time.sleep(.1)
	def Read_Reply_Data(self,id):
...
def main():
	...
	#tm.Enable_three_motor()
	#tm.mmc.enable_motor(2)
	#tm.mmc.disable_motor(1)
	while 1:
		tm.mmc.send_command(1, 0, 0, 0, 0,  0)
		#print("1----->")
		time.sleep(.1)
		tm.Read_Reply_Data(1)
		time.sleep(.1)
		tm.mmc.send_command(2, 0, 0, 0, 0,  0)
		time.sleep(.1)
		#print("2----->")
		tm.Read_Reply_Data(2)
		time.sleep(.1)
		tm.mmc.send_command(3, 0, 0, 0, 0,  0)
		time.sleep(.1)
		#print("3----->")
		tm.Read_Reply_Data(3)
		# time.sleep(.1)
	# t_des=-48
	# kp=200
	# kd=0.3
